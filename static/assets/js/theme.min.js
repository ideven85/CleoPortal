...
const HSBsDropdown = {
        init(e) {
            ...
            window.addEventListener("show.bs.dropdown", (e => {
                if ( !e.target.hasAttribute("data-bs-dropdown-animation")) return;
                const t = e.target.nextElementSibling;
                t.style.opacity = 0, setTimeout((() => {
                    t.style.transform = `${t.style.transform} translateY(10px)`
                })), setTimeout((() => {
                    t.style.transform = `${t.style.transform} translateY(-10px)`, t.style.transition = "transform 300ms, opacity 300ms", t.style.opacity = 1
                }), 100)
        ...
        "data-hs-validation-equal-field": e => {
            ...
            e.addEventListener("input", (i => {
                t.value.toString().toLocaleLowerCase() !== i.target.value.toString().toLocaleLowerCase() ? e.setCustomValidity("qual-field") : e.setCustomValidity(""), HSBsValidation.updateFieldStete(e)
            })), t.addEventListener("input", (t => {
                e.value.toString().toLocaleLowerCase() !== t.target.value.toString().toLocaleLowerCase() ? e.setCustomValidity("qual-field") : e.setCustomValidity(""), HSBsValidation.updateFieldStete(e)
            }))
        }
    }, HSBsValidation = {
        init(e, t) {
            ...
            return Array.prototype.slice.call(i).forEach((e => {
                ...
                this.addVlidationListners(e.elements), e.addEventListener("submit", (i => {
                    e.checkValidity() ? this.onSubmit({
                        event: i,
                        form: e,
                        options: t
                    }) : (i.preventDefault(), i.stopPropagation(), this.checkFieldsState(e.elements)), e.classList.add("was-validated")
                }), !1)
            })), this
        }, addVlidationListners(e) {
            Array.prototype.slice.call(e).forEach((e => {
                const t = e.closest("[data-hs-validation-validate-class]");
                t && (e.addEventListener("input", (e => this.updateFieldStete(e.target))), e.addEventListener("focus", (e => t.classList.add("focus"))), e.addEventListener("blur", (e => t.classList.remove("focus"))))
            }))
        }, checkFieldsState(e) {
            Array.prototype.slice.call(e).forEach((e => this.updateFieldStete(e)))
        }, updateFieldStete(e) {
            const t = e.closest("[data-hs-validation-validate-class]");
            t && (e.checkValidity() ? (t.classList.add("is-valid"), t.classList.remove("is-invalid")) : (t.classList.add("is-invalid"), t.classList.remove("is-valid")))
...
HSCore.components.HSChartJS = {
    init: function (e, t) {
        if (this.$el = "string" == typeof e ? document.querySelector(e) : e, this.$el) {
            ...
            return this.settings = mergeDeep(this.defaults, {...t, ...i}), new Chart(e, this.settings)
        }
    }
}
    /*  * Circles wrapper
  ...
  */, HSCore.components.HSCircles = {
    ...
    init(e, t, i) {
        ...
        for (let e = 0; e < o.length; e += 1) l.addToCollection(o[e], t, i || o[e].id);
    ...
    setTextStyles: function (e, t, i) {
        e.querySelectorAll('[class="' + (t.textClass || i._textClass) + '"]').forEach((e => {
            e.style.fontSize = `${t.textFontSize}px`, e.style.fontWeight = t.textFontWeight, e.style.color = t.textColor, e.style.lineHeight = "normal", e.style.height = "auto", e.style.top = "", e.style.left = ""
        }))
    },
    setRtl: function (e, t) {
    ...
    getItems() {
        const e = this;
        let t = [];
        for (let i = 0; i < e.collection.length; i += 1) t.push(e.collection[i].$initializedEl);
        return t
    },
    getItem(e) {
    ...
    _init() {
        ...
        for (let t = 0; t < e.collection.length; t += 1) {
            let i, l;
            e.collection[t].hasOwnProperty("$initializedEl") || (i = e.collection[t].options, l = e.collection[t].$el, i.isViewportInit && (i.value = 0), e.setId(l, i), e.collection[t].$initializedEl = Circles.create(i), e.setTextStyles(l, i, e.collection[t].$initializedEl), i.rtl && e.setRtl(l, i), i.fgStrokeLinecap && e.setStrokeLineCap(l, i, e.collection[t].$initializedEl), i.fgStrokeMiterlimit && e.setStrokeMiterLimit(l, i, e.collection[t].$initializedEl), i.isViewportInit && e.initAppear(l, i, e.collection[t].$initializedEl))
        }
    }
}
    /*
...
*/, HSCore.components.HSDropzone = {
    ...
    _init() {
        ...
        for (let t = 0; t < e.collection.length; t += 1) {
            let i, l;
            e.collection[t].hasOwnProperty("$initializedEl") || (i = e.collection[t].options, l = e.collection[t].$el, e.collection[t].$initializedEl = new Dropzone(l, i))
        }
    }
}
    /*
...
*/, HSCore.components.HSMask = {
    ...
    _init() {
        ...
        for (let t = 0; t < e.collection.length; t += 1) {
            let i, l;
            e.collection[t].hasOwnProperty("$initializedEl") || (i = e.collection[t].options, l = e.collection[t].$el, e.collection[t].$initializedEl = new IMask(l, i))
        }
    }
    ...
    init: function (e, t) {
        if (this.$el = "string" == typeof e ? document.querySelector(e) : e, this.$el) {
            ...
            if (l.setView(this.settings.map.coords, this.settings.map.zoom), L.tileLayer(this.settings.layer.token, this.settings.layer).addTo(l), this.settings.marker) for (var o = 0; o < this.settings.marker.length; o++) {
    ...
    initializeHover: function (e, t, i) {
        const l = this;
        var o = e.querySelector(`.${i.searchClass}`), n = !1;
        o.addEventListener("keydown", (s => {
            if (40 === s.which) s.preventDefault(), l.searchMenuShow(e, t, i), (a = i.list.querySelector(".active")) ? a.nextElementSibling && ((r = a.nextElementSibling).classList.add("active"), n.classList.remove("active"), n = r, i.list.offsetHeight < r.getBoundingClientRect().top && (i.list.scrollTop = r.getBoundingClientRect().top + i.list.scrollTop)) : (n = i.list.firstChild).classList.add("active"); else if (38 === s.which) {
                var a, r;
    ...
    searchMenuHide: function (e, t, i) {
        ...
        t.searchMenuOutsideClose && document.addEventListener("click", (() => {
            l.helpers.fadeOut(i.list, t.searchMenuDelay), t.clearSearchInput && (o.value = "")
...
*/, HSCore.components.HSNoUISlider = {
    ...
    _init() {
        ...
        for (let t = 0; t < e.collection.length; t += 1) {
            let i, l;
            e.collection[t].hasOwnProperty("$initializedEl") || (i = e.collection[t].options, l = e.collection[t].$el, e.collection[t].$initializedEl = noUiSlider.create(l, i), e.collection[t].$initializedEl.on("update", (() => {
                e.updateMinField(e.collection[t].$initializedEl, i), e.updateMaxField(e.collection[t].$initializedEl, i), e.updateChart(e.collection[t].$initializedEl, i)
            })), i.showTooltips && e.showTooltips(e.collection[t].$initializedEl, i), i.result_min_target_el && e.resultMinTargetEl(e.collection[t].$initializedEl, i), i.result_max_target_el && e.resultMaxTargetEl(e.collection[t].$initializedEl, i))
        }
    },
    ...
    updateChart: function (e, t) {
        const i = 100 * parseInt(e.get()[0]) / t.range.max, l = 100 * parseInt(e.get()[1]) / t.range.max;
        if (t.foreground_target_el && e.get().length <= 2) {
            var o = 100 - (i + (100 - l));
            const e = document.querySelector(t.foreground_target_el);
            e.style.left = `${i}%`, e.style.width = `${o}%`;
            const n = document.querySelector(t.foreground_target_el + "> *");
            n.style.width = `${e.parentElement.clientWidth}px`, n.style.marginLeft = -e.parentElement.clientWidth / 100 * i + "px"
        }
    },
...
*/, HSCore.components.HSQuill = {
    dataAttributeName: "data-hs-quill-options", defaults: {theme: "snow", attach: !1}, collection: [], init(e, t, i) {
        const l = this;
        let o;
        o = e instanceof HTMLElement ? [e] : e instanceof Object ? e : document.querySelectorAll(e);
        for (let e = 0; e < o.length; e += 1) l.addToCollection(o[e], t, i || o[e].id);
        ...
        for (let t = 0; t < e.collection.length; t += 1) {
            let i, l;
            e.collection[t].hasOwnProperty("$initializedEl") || (i = e.collection[t].options, l = e.collection[t].$el, e.collection[t].$initializedEl = new Quill(l, i), l.classList.add("hs-quill-initialized"), this.toolbarBottom(i, e.collection[t].$initializedEl))
        }
    }, toolbarBottom: function (e, t) {
        if (e.toolbarBottom) {
            const i = t.container, l = i.previousElementSibling;
            if (i.parentElement.classList.add("ql-toolbar-bottom"), e.attach) {
                document.querySelector(e.attach).addEventListener("shown.bs.modal", (() => {
                    i.style.paddingBottom = l.offsetHeight + "px"
                }))
            } else i.style.paddingBottom = l.offsetHeight + "px";
            l.style.position = "absolute", l.style.width = "100%", l.style.bottom = 0
        }
    }
}
    /*
...
*/, HSCore.components.HSTomSelect = {
    ...
    _init() {
        ...
        for (let t = 0; t < e.collection.length; t += 1) {
            let i, l;
            e.collection[t].hasOwnProperty("$initializedEl") || (i = e.collection[t].options, l = e.collection[t].$el, i.plugins.hasOwnProperty("hs_smart_position") && !l.closest(".modal") && (i.dropdownParent = "body"), l.hasAttribute("multiple") && (i.plugins = [...i.plugins, "remove_button"]), i.searchInDropdown && (i.plugins = [...i.plugins, "dropdown_input"]), TomSelect.define("hs_smart_position", (function (e) {
                this.hook("after", "setup", (function () {
                    this.$menu = this.dropdown_content.parentElement, this.on("dropdown_open", (e => {
                        const t = e.getBoundingClientRect(), l = this.wrapper.getBoundingClientRect();
                        t.bottom > window.innerHeight && (e.style.top = parseInt(e.style.top) - (this.control.clientHeight + e.clientHeight + 10) + "px"), e.style.opacity = 0, setTimeout((() => {
                            const o = parseInt(e.style.width);
                            o > l.width && i.dropdownLeft && (e.style.left = parseInt(e.style.left) - Math.abs(t.width - o) + "px"), e.style.opacity = 1
                        }))
            ...
            })), e.collection[t].$initializedEl = new TomSelect(l, i), i.hideSearch && e.hideSearch(e.collection[t].$initializedEl, i), i.disableSearch && e.disableSearch(e.collection[t].$initializedEl, i), i.width && e.width(e.collection[t].$initializedEl, i), i.singleMultiple && e.singleMultiple(e.collection[t].$initializedEl, i), i.hidePlaceholderOnSearch && e.hidePlaceholderOnSearch(e.collection[t].$initializedEl, i), i.create && e.openIfEmpty(e.collection[t].$initializedEl, i), i.hideSelectedFromField && e.hideSelectedFromField(e.collection[t].$initializedEl, i), i.dropdownWidth && e.dropdownWidth(e.collection[t].$initializedEl, i), e.renderPlaceholder(e.collection[t].$initializedEl, i), e.wrapContainer(e.collection[t].$initializedEl, i))
        }
    },
    hideSearch(e, t) {
    ...
    singleMultiple(e, t) {
        ...
        const i = (e.control_input.getAttribute("placeholder") || t.placeholder).replace(/(<([^>]+)>)/gi, ""),
            l = t => {
                t.target.closest("[data-selectable].selected") && (t.target.classList.remove("selected"), setTimeout((() => {
                    e.removeItem(t.target.getAttribute("data-value"), !1), e.refreshItems()
                })))
            }, o = t => {
                if ( !e.wrapper.querySelector(".ts-selected-count")) {
                    const t = document.createElement("span");
                    t.classList.add("ts-selected-count"), e.wrapper.querySelector(".ts-control").appendChild(t)
                }
                return e.wrapper.querySelector(".ts-selected-count").innerHTML = t
            };
        e.items.length && (t.searchInDropdown ? o(e.items.length ? `${e.items.length} item(s) selected` : i) : e.control_input.setAttribute("placeholder", `${e.items.length} item(s) selected`)), e.on("dropdown_open", (e => {
    ...
    openIfEmpty(e, t) {
        e.control_input.addEventListener("focus", (() => {
            e.$menu.querySelector(".option") || (e.open(), setTimeout((() => {
                e.$menu.style.display = "block", e.$menu.querySelector(".ts-dropdown-content").append(e.render("no_results"))
            }), 10))
        }))
    },
    hideSelectedFromField(e, t) {
        ...
        e.on("item_select", i), e.on("item_add", i)
    },
    dropdownWidth(e, t) {
    ...
    renderPlaceholder(e, t) {
        if (t.singleMultiple || e.items.length) return;
        const i = e.input.getAttribute("placeholder") || t.placeholder;
        if (t.searchInDropdown && !t.hideSelected) {
            let t = null;
            const l = function () {
                if (t = e.wrapper.querySelector(".ts-custom-placeholder"), e.items.length && t) return t.parentElement && t.parentElement.removeChild(t), t = null;
                e.items.length || t || o()
            }, o = function () {
                e.items.length || (e.wrapper.querySelector(".ts-control").innerHTML = `<span class="ts-custom-placeholder">${i}</span>`, t = e.wrapper.querySelector(".ts-custom-placeholder"))
            };
            o(), e.on("change", l)
        }
    ...
    wrapContainer(e, t) {
        ...
        i.className += t.dropdownWrapperClass, e.$menu.parentNode.insertBefore(i, e.$menu), i.appendChild(e.$menu)
    }
